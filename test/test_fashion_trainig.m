...
movie_index = Index(600);
pixel_index = Index(785);
genre_index = Index(10);

X = Tensor( pixel_index, movie_index );
Z1 = Tensor( genre_index, movie_index);
Z2 = Tensor( genre_index, pixel_index );

load data/fashion/fashionmnisttrain.mat
X.data = fashionmnisttrain;
X.data = rand( pixel_index.cardinality, movie_index.cardinality );

Z1.data = rand( genre_index.cardinality, movie_index.cardinality );
Z2.data = rand( genre_index.cardinality, pixel_index.cardinality );
