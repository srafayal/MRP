...
zip=2000/number_of_training;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class0_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class1_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class2_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class3_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class4_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class5_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class6_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class7_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class8_scores.mat')
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\Training_scores\class9_scores.mat')
...
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model0.mat')
model0=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model1.mat')
model1=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model2.mat')
model2=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model3.mat')
model3=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model4.mat')
model4=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model5.mat')
model5=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model6.mat')
model6=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model7.mat')
model7=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model8.mat')
model8=model;
load('C:\Users\srafayal\Desktop\MRP\tft-master\test\experiment\fold\4\fold_5\model9.mat')
model9=model;
...
%             re=abs(pinv(U1)*T.data*pinv(U2 )) ;
            ...
            for k = 1:number_of_training
                ...
                re= U1 *squeeze(core0(class0_scores{m,1},:,:))* U2 ;
            ...
            for k = 1:number_of_training
                ...
                re= U1 *squeeze(core1(class1_scores{m,1},:,:))* U2 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
...
%                D=norm((re-squeeze(core2(k,:,:))), 'fro');
                ...
                re= U1 *squeeze(core2(class2_scores{m,1},:,:))* U2 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
                if(D<temp1)
                    temp1=D;
...
%                  D=norm((re-squeeze(core3(k,:,:))), 'fro');
                ...
                re= U1 *squeeze(core3(class3_scores{m,1},:,:))* U2 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
                if(D<temp1)
                    temp1=D;
...
%                 D=norm((re-squeeze(core4(k,:,:))), 'fro');
                ...
                re= U1 *squeeze(core4(class4_scores{m,1},:,:))* U2 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
                if(D<temp1)
                    temp1=D;
...
%                   D=norm((re-squeeze(core5(k,:,:))), 'fro');
                ...
                re= U1 *squeeze(core5(class5_scores{m,1},:,:))* U2 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
                 if(D<temp1)
                    temp1=D;
                 ...
                 m=1;           
           U1_6=squeeze(model6.Z_alpha(1,1).data( :,1,1,:));% *core*
           U2_6=permute(squeeze(model6.Z_alpha(1,2).data( 1,:,1,1,:)),[2,1]);
           for k = 1:number_of_training
%                 D=norm((re-squeeze(core6(k,:,:))), 'fro');
                %D =pdist2(norm(re, 'fro'),norm(squeeze(core6(k,:,:)), 'fro'),'euclidean');
                 
                re= U1_6 *squeeze(core6(class6_scores{m,1},:,:))* U2_6 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
                if(D<temp1)
                    temp1=D;
...
%                 D=norm((re-squeeze(core7(k,:,:))), 'fro');
                ...
                re= U1 *squeeze(core7(class7_scores{m,1},:,:))* U2 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
                if(D<temp1)
                    temp1=D;
...
%                 D=norm((re-squeeze(core8(k,:,:))), 'fro');
                ...
                re= U1 *squeeze(core8(class8_scores{m,1},:,:))* U2 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
                if(D<temp1)
                    temp1=D;
...
%                  D=norm((re-squeeze(core9(k,:,:))), 'fro');
               % D =pdist2(norm(re, 'fro'),norm(squeeze(core9(k,:,:)), 'fro'),'euclidean');
                ...
                re= U1 *squeeze(core9(class9_scores{m,1},:,:))* U2 ;
                D=norm((T.data-re), 'fro');
                m=m+zip  ;
               if(D<temp1)
                    temp1=D;
